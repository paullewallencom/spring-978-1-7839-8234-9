...
@ContextConfiguration(locations = { "/test-context-hsql.xml" })
public class DerbySpringJdbcTest {
	private static final Logger logger = LoggerFactory.getLogger(DerbySpringJdbcTest.class);
	...
	DataSource getHsqlDatasource() {
		...
		return new EmbeddedDatabaseBuilder().setType(EmbeddedDatabaseType.HSQL)
				.addScript("db-scripts/db-schema-hsql.sql")
				.addScript("db-scripts/data-hsql.sql")
				.addScript("db-scripts/storedprocs-hsql.sql")
				.addScript("db-scripts/functions-hsql.sql")
				.setSeparator("/")
				.build();
		//
