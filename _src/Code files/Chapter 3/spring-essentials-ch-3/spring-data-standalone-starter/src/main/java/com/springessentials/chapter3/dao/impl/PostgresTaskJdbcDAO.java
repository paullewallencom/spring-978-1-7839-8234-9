...
@Repository("PostgresTaskJdbcDAO")
@Transactional
public class PostgresTaskJdbcDAO implements TaskDAO {
...
//	private SimpleJdbcCall openTasksByAssigneeIdStoreProc;
	...
	@Autowired
	public PostgresTaskJdbcDAO(DataSource dataSource, @Qualifier("UserJdbcDAO") UserDAO userDAO) {
