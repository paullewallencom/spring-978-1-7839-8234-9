...
import com.springessentials.chapter3.boot.JpaConfiguration;
...
public class TestSuite {
	...
	void addAUser() {
		User user = userService.createNewUser(new User(null, "Rineesh K", "rineesh", "password987", prepareDate(1, 1, 1978)));
	}

	void addSomeUsers() {

		List<User> userList = new ArrayList<>();
		userList.add(new User(null, "Shameer Kunjumohamed", "sameerean", "password98456", prepareDate(8, 2, 1977)));
