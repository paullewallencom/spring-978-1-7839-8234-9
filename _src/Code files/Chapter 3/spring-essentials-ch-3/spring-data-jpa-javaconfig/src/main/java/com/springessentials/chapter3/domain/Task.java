...
public class Task {
	...
	public String toString() {
		return "Task [id=" + id + ", name=" + name + ", priority=" + priority + ", status=" + status + ", createdBy=" + createdBy + ", createdDate="
				+ createdDate + ", modifiedBy=" + modifiedBy + ", modifiedDate=" + modifiedDate + ", assignee=" + assignee + ", completedDate=" + completedDate
				+ ", comments=" + comments + "]";
	}
