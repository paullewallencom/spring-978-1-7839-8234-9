...
public class TestSuite {
	...
	void closeSomeTasks() {
		User shameer = userService.findByUserName("sameerean");
		List<Task> shameerTasks = taskService.findTasksByAssigneeUserName(shameer.getUserName());
	...
	void findTasksByAssignee() {
		...
		List<Task> tasks = taskService.findTasksByAssigneeUserName("sameerean");
		logger.info("Tasks by shameer = " + tasks);

		logger.info("============ Finding Completed Tasks by shameer... ================ ");
		tasks = taskService.findCompletedTasksByAssigneeUserName("sameerean");
		logger.info("Completed Tasks by shameer = " + tasks);

		logger.info("============ Finding Open Tasks by shameer... ================ ");
		tasks = taskService.findOpenTasksByAssigneeUserName("sameerean");
