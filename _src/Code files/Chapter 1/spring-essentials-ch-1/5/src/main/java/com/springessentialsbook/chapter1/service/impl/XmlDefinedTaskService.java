...
public class XmlDefinedTaskService implements TaskService {

	private static final Logger logger = LoggerFactory
			.getLogger(XmlDefinedTaskService.class);

	private UserService userService;
	private TaskDAO taskDAO;

	public XmlDefinedTaskService(UserService userService, TaskDAO taskDAO) {
		super();
