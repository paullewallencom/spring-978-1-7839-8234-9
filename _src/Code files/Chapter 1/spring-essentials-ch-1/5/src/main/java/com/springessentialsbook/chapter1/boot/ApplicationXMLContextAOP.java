...
public class ApplicationXMLContextAOP {
	public static final Logger logger = LoggerFactory.getLogger(ApplicationXMLContextAOP.class);

	public static void main(String[] args) {
		ApplicationContext context =
			    new ClassPathXmlApplicationContext(new String[] {"xml-application-context-aop.xml"});
